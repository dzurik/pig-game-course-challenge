...
//document.querySelector('#current-' + activePlayer).textContent = dice; // csao szöveget ír át
//document.querySelector('#current-' + activePlayer).innerHTML = '<em>' + dice + '</em>'; // html taget is lehet használni

//var x = document.querySelector('#score-1').textContent; console.log(x); // olvasni is jó, hogy score-1 mennyi az értéke
